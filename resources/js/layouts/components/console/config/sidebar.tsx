        ...
        children: [
            {
                ...
                label: 'PPID',
                url: '/console/profile/ppid',
                permissions: ['read p-ppid'],
            },
            {
                id: 'a19cc394-4736-4cf7-a557-65080dd2d9a2',
                label: 'Pejabat Publik',
                url: '/console/profile/public-officers',
        ...
        children: [
            {
                ...
                url: '/console/master-data/offices',
